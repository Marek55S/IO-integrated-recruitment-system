...
const PROGRAMS: Program[] = [
  {
    ...
    description: 'Metody Wytwarzania Oprogramowania opis',
  ...
  },
  {
    ...
    description: 'Analiza Danych - Data Science opis',
  ...
  },
  {
    ...
    description: 'Systemy Baz Danych opis',
  ...
  },
  {
    ...
    description: 'Cyberbezpieczeństwo w praktyce opis',
  ...
  },
  {
    ...
    description: 'Systemy ERP - ścieżka SAP S/4HANA opis',
  ...
  },
  {
    ...
    image_src:
      '/programs/systemy-erp-sciezka-inzynieria-oprogramowania-dla-sap-hana-erp-i-programowanie-w-jezyku-abap.png',
    is_active: true,
  },
  {
    ...
    image_src:
      '/programs/systemy-erp-sciezka-analiza-biznesowa-w-systemach-erp-oraz-bi-business-intelligence-information-management.png',
    is_active: true,
  },
  {
    id: 'podstawy-analityki-danych-w-biznesie',
    name: 'Podstawy analityki danych w biznesie',
    description: 'Podstawy analityki danych w biznesie opis',
  ...
  },
  {
    ...
    description: 'Uczenie maszynowe w analityce danych opis',
  ...
  },
  {
    ...
    description: 'Inżynieria systemów sztucznej inteligencji opis',
  ...
  },
  {
    ...
    description: 'Analiza kryminalna opis',
